...
const HelpManager = {
    ...
    showModal() {
        ...
        contentBox.innerHTML = `
            ...
            <div class="help-desc">${this.escapeHtml(this.data.content).replace(/\n/g, '<br>')}</div>
            <hr class="popup-hr">
            <ul class="popup-info-list">
                <li><span class="label">최근 업데이트</span> <span class="value">${this.escapeHtml(this.data.updateDate)}</span></li>
